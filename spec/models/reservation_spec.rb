...
RSpec.describe Reservation, type: :model do
  describe "Campus vazios não devem passar" do
    ...
    reserva = Reservation.create!(start_date: 2.days.from_now, end_date:7.days.from_now, guest_number: 2, room_id: room.id, status: 0)
    reserva2 = Reservation.new(start_date: 2.days.from_now, end_date:7.days.from_now, guest_number: 2, room_id: room.id)
    # Act
    reserva2.valid?
