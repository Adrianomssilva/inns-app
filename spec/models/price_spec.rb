...
RSpec.describe Price, type: :model do
  ...
  describe "a data do preço não pode sobrepor outra data" do
    it "deve ocorrer um erro" do
      ...
      price1 = Price.create!(value: '200', date_start: '2023-11-20', date_end: '2023-11-30', room: room)
      price2 = Price.new(value: '200', date_start: '2023-11-20', date_end: '2023-12-20', room: room)
